...
CREATE TABLE Person(
    PersonId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY ,
    LastName VARCHAR(30),
...
CREATE TABLE PhoneNumber(
    PId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY ,
...
CREATE TABLE Address (
    AId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY , 
...
CREATE TABLE Email (
    EId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY ,
    PersonId INTEGER NOT NULL,
...
CREATE TABLE Employee (
    EmployeeId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY , 
    PersonId NUMBER NOT NULL,
    Username VARCHAR(20), 
...
CREATE TABLE Officer(
    ...
    BadgeId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY ,
...
CREATE TABLE ForensicExpert(
    EmployeeId NUMBER NOT NULL,
    ForensicExpertId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY ,
...
CREATE TABLE Visit (
    VisitId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY ,
    PersonId NUMBER NOT NULL,
    DateofVisit DATE, 
    Reason VARCHAR2(255),
...
CREATE TABLE Arrest (
    ArrestNumber NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY ,
    PersonId NUMBER NOT NULL,
...
CREATE TABLE "Case" (
    CaseId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY , 
    Title VARCHAR(50),
    DateEntered DATE, 
    Status VARCHAR(10)
);
...
-- CaseAssignment(CaseId, EmployeeId)
CREATE TABLE CaseAssignment (
    CaseId NUMBER,
    EmployeeId NUMBER,
    
    CONSTRAINT PK_CaseAssignment
        PRIMARY KEY (CaseId, EmployeeId),
    CONSTRAINT fk_CaseAssignment_CaseId
        FOREIGN KEY (CaseId) 
        REFERENCES "Case"(CaseId),
    CONSTRAINT fk_CaseAssignment_EmployeeId
        FOREIGN KEY (EmployeeId) 
        REFERENCES Employee(EmployeeId)
);
...
CREATE TABLE CaseNote (
    NoteId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY ,
    Note VARCHAR2(2048),
    EmployeeId NUMBER,
    DateEntered DATE,
    CaseId NUMBER,
...
CREATE TABLE Evidence (
    EvidenceId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY ,
    CaseId NUMBER,
    "Date" DATE, 
    Address VARCHAR(150), 
...
CREATE TABLE ForensicTest (
    TestId NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 5000) PRIMARY KEY , 
    EvidenceId NUMBER,
