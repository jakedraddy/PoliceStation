...
CREATE TABLE Officer(
    ...
    BadgeId NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE ForensicExpert(
    EmployeeId NUMBER NOT NULL,
    ForensicExpertId NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Visit (
    VisitId NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    PersonId NUMBER NOT NULL,
    DateofVisit DATE, 
    Reason VARCHAR2(255),
...
CREATE TABLE Arrest (
    ArrestNumber NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    PersonId NUMBER NOT NULL,
...
CREATE TABLE "Case" (
    CaseId NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, 
    Title VARCHAR(50),
    DateEntered DATE, 
    Status VARCHAR(10)
);
...
CREATE TABLE Evidence(
    EvidenceId NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    CaseId NUMBER,
    "Date" DATE, 
    Address VARCHAR(150), 
...
CREATE TABLE ForensicTest (
    TestId NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, 
    EvidenceId NUMBER,
